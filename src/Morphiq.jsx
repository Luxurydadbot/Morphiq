    ...
    <Layout activeNav="progress">
      <div style={{ padding:"1.25rem 1.25rem 0" }}>
        <div style={{ marginBottom:16 }}>
          ...
          <div style={{ fontSize:12, color:theme.textDim, marginTop:2 }}>Week 6 · Fat loss plan</div>
        </div>

        <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr 1fr", gap:8, marginBottom:16 }}>
          {[
            { val:`−${lost} lbs`, lbl:"Weight lost",    color:a },
          ...
          <div className="mq-fade">
            <div style={{ background:"#1A2332", borderRadius:14, padding:"14px 14px 10px", marginBottom:12 }}>
              <div style={{ display:"flex", justifyContent:"space-between", alignItems:"flex-start", marginBottom:10 }}>
                <div>
                  <div style={sL}>Weight trend</div>
                  <div style={{ fontSize:26, fontWeight:700, color:theme.text, lineHeight:1 }}>{curr} <span style={{ fontSize:13, color:"#6B7A8D", fontWeight:400 }}>lbs</span></div>
                  <div style={{ fontSize:12, color:a, marginTop:2 }}>↓ {lost} lbs since day 1</div>
                </div>
            ...
            <div style={{ background:"#1A2332", borderRadius:14, overflow:"hidden", marginBottom:12 }}>
              {[
                { label:"Weight",        start:"187 lbs", current:`${curr} lbs`,   delta:`−${lost}`,   dColor:a },
                { label:"Body fat est.", start:"24%",     current:"21%",            delta:"−3%",        dColor:a },
                { label:"Waist",         start:"36 in",   current:"34.5 in",        delta:"−1.5 in",    dColor:a },
              ].map((row, i, arr) => (
