    ...
    async function load() {
      try {
        const res = await fetch(
          ...
          { headers: { "apikey": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InV2bnlqZWdtaHN6dGVkbmpjbGIiLCJyb2xlIjoiYW5vbiIsImlhdCI6MTc3ODcxODAyNywiZXhwIjoyMDk0Mjk0MDI3fQ.-hMNwCO-GymvbiyAKer6Q5AjDbDZl6GhXmSTmr5bY04", "Authorization": "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InV2bnlqZWdtaHN6dGVkbmpjbGIiLCJyb2xlIjoiYW5vbiIsImlhdCI6MTc3ODcxODAyNywiZXhwIjoyMDk0Mjk0MDI3fQ.-hMNwCO-GymvbiyAKer6Q5AjDbDZl6GhXmSTmr5bY04" } }
        );
